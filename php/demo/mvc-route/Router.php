...
class Router
{
    ...
    public static function dispatch()
    {
        ...
        // Replace Gateway path
        if (self::$gateway) $uri = str_replace(self::$gateway, '', $uri);
            ...
            foreach ($route_pos as $route) {
                ...
                if (self::$methods[$route] == $method || self::$methods[$route] == 'ANY' || (!empty(self::$maps[$route]) && in_array($method, self::$maps[$route]))) {
                    ...
                    if (!is_object(self::$callbacks[$route])) {
                        ...
                        if (self::$project) $segments[0] = self::$project . $segments[0];
     ...
     * @param $path
     */
    public static function setGateway($path)
    {
        self::$gateway = $path;
    }
     ...
     * @param $path
     */
    public static function setProject($path)
    {
        self::$project = $path;
    }
