...
public class ClassUtils {
    ...
    public static final <T> T cast(Object value, Class<T> type) {
        ...
        if (ClassUtils.instanceOf(value.getClass(), type)) {
            ...
            //todo newVal = DateTimeUtils.formatUnknownString2Date(value.toString());
        } else if (type == String.class) {
            if (value instanceof Date) {
                //todo   newVal = DateTimeUtils.format(((Date) value), DateTimeUtils.YEAR_MONTH_DAY_HOUR_MINUTE_SECOND);
            } else
